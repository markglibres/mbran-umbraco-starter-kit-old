...
#pragma warning restore 0109
		...
		///<summary>
		/// Contact Details Page: If empty, contact from Site Config will be used
		///</summary>
		[ImplementPropertyType("contactDetailsPage")]
		public IPublishedContent ContactDetailsPage
		{
			get { return this.GetPropertyValue<IPublishedContent>("contactDetailsPage"); }
		}
	}
}
